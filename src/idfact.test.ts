...
describe('buildIdfact', () => {
  it('joins NIF, full number and the Spanish tax date as YYYYMMDD', () => {
  ...
  it('uses the Spanish calendar day at the end-of-day boundary', () => {
    // 31 Dec 23:30 UTC is already 1 Jan in mainland Spain.
    const date = new Date('2026-12-31T23:30:00.000Z')
    expect(buildIdfact('B1', 'X', date)).toBe('B1-X-20270101')
  })
})
